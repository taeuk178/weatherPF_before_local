...
struct ThreeDaysWeather: Codable {
...
let apiurl = "https://apis.openapi.sk.com/weather/forecast/3days?version=2&lat=37.498206&lon=127.02761&appKey=l7xx522b5771a40d42a59a3fafcdeadf41cb"
...
let task = session.dataTask(with: url) { (data, response, error) in
    ...
    guard let httpResponse = response as? HTTPURLResponse else{
        ...
        do{
            ...
            let forecast = try decoder.decode(ThreeDaysWeather.self, from: data)
